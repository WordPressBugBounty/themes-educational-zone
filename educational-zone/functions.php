...
function educational_zone_themepage(){
	...
	$educational_zone_theme_test = wp_get_theme();
...
function educational_zone_info_page() {
	...
	<div class="wrap about-wrap educational-zone-add-css">
			...
			<div class="feature-section three-col">
				...
				<div class="col">
					<div class="widgets-holder-wrap">
						...
						<p><a target="_blank" href="<?php echo esc_url( EDUCATIONAL_ZONE_GET_PREMIUM_PRO ); ?>" class="button button-primary get prem">
				...
				<div class="col">
					<div class="widgets-holder-wrap">
						<h3><?php esc_html_e("Free Documentation", "educational-zone"); ?></h3>
						<p><?php esc_html_e("Our guide is available if you require any help configuring and setting up the theme. Easy and quick way to setup the theme.", "educational-zone"); ?></p>
						<p><a target="_blank" href="<?php echo esc_url( EDUCATIONAL_ZONE_FREE_DOC ); ?>" class="button button-primary get">
							<?php esc_html_e("Free Documentation", "educational-zone"); ?>
						</a></p>
					</div>
				</div>
			</div>
		...
		<div class="educational-zone-button-container">
			<a target="_blank" href="<?php echo esc_url( EDUCATIONAL_ZONE_GET_PREMIUM_PRO ); ?>" class="button button-primary get prem">
